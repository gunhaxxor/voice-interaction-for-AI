...
import { type ConfigurableWindow, defaultWindow, useSupported } from '@vueuse/core'
 ...
 */
export function useSpeechSynthesisCustom(
  ...
  const speak = () => {
    ...
    if (utterance.value)
      console.log('utterance', utterance.value);
